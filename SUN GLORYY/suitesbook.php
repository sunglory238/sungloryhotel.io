...
<body>
    ...
    <section class="container">
      <header >RESERVATION SUITES</header>
      <form action="suitesbookre.php" class="form" method="post">
        <div class="input-box">
        ...
        <div class="column">
          ...
          <div class="input-box">
            ...
            <select name="suites">
              <option selected>Suites Room</option>
              <option value="Meeting Room">Meeting Room</option>
              <option value="Ballroom">Ballroom</option>
              <option value="Coral Room">Coral Room</option>
